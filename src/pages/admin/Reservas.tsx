  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold">Reservas do Salão</h1>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          placeholder="Buscar por morador, data..."
      ...
      <div className="text-sm text-text-3">Conecte o Supabase para ver as reservas.</div>
    </div>
  )
}
