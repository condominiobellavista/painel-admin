  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold">Mudanças</h1>
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          placeholder="Buscar por apto, morador..."
      ...
      <div className="text-sm text-text-3">Conecte o Supabase para ver as mudanças agendadas.</div>
    </div>
  )
}
